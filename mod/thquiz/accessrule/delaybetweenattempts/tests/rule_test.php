...
namespace thquizaccess_delaybetweenattempts;

use thquiz;
use thquizaccess_delaybetweenattempts;

defined('MOODLE_INTERNAL') || die();

global $CFG;
require_once($CFG->dirroot . '/mod/thquiz/accessrule/delaybetweenattempts/rule.php');


/**
 * Unit tests for the thquizaccess_delaybetweenattempts plugin.
 *
 * @package    thquizaccess_delaybetweenattempts
 * @category   test
...
class rule_test extends \basic_testcase {
    public function test_just_first_delay() {
        ...
        $cm = new \stdClass();
        $cm->id = 0;
        $thquizobj = new thquiz($thquiz, $cm, null);
        $attempt = new \stdClass();
        $attempt->timefinish = 10000;

        $rule = new thquizaccess_delaybetweenattempts($thquizobj, 10000);
        ...
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(11000)));
        ...
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(10001)));
        $this->assertFalse($rule->prevent_new_attempt(2, $attempt));
    }
    ...
    public function test_just_both_delays() {
        ...
        $this->assertFalse($rule->prevent_new_attempt(5, $attempt));
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(12000)));
        $this->assertEquals($rule->prevent_new_attempt(2, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(11000)));
        $this->assertEquals($rule->prevent_new_attempt(3, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(11000)));
        ...
        $attempt->timefinish = 9001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(11001)));
        $this->assertEquals($rule->prevent_new_attempt(2, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(10001)));
        $this->assertEquals($rule->prevent_new_attempt(4, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(10001)));
    ...
    public function test_with_close_date() {
        ...
        $attempt->timefinish = 13000;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'thquizaccess_delaybetweenattempts', userdate(15000)));
        $attempt->timefinish = 13001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youcannotwait', 'thquizaccess_delaybetweenattempts'));
        ...
        $rule = new thquizaccess_delaybetweenattempts($thquizobj, 15000);
        $attempt->timefinish = 13000;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
        $attempt->timefinish = 13001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
        ...
        $rule = new thquizaccess_delaybetweenattempts($thquizobj, 15001);
        $attempt->timefinish = 13000;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
        $attempt->timefinish = 13001;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
