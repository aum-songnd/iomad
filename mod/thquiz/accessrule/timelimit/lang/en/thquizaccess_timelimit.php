...
/**
 * Strings for the thquizaccess_timelimit plugin.
 *
...
$string['pluginname'] = 'Time limit thquiz access rule';
$string['privacy:metadata'] = 'The Time limit thquiz access rule plugin does not store any personal data.';
$string['thquiztimelimit'] = 'Time limit: {$a}';
