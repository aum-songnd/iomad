...
/**
 * Base class for rules that restrict the ability to attempt a thquiz.
 *
 * @package   mod_thquiz
...
/**
 * A base class that defines the interface for the various thquiz access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class thquiz_access_rule_base {
    /** @var stdClass the thquiz settings. */
    protected $thquiz;
    /** @var thquiz the thquiz object. */
    protected $thquizobj;
     ...
     */
    public function __construct($thquizobj, $timenow) {
        $this->thquizobj = $thquizobj;
        $this->thquiz = $thquizobj->get_thquiz();
     ...
     *
     * @param mod_thquiz_preflight_check_form $thquizform the form being built.
    ...
    /**
     * This is called when the current attempt at the thquiz is finished. This is
     ...
     * this thquiz, then return true. This is used so we can know whether to display a
    ...
    /**
     * @return array key => lang string any choices to add to the thquiz Browser
     ...
     */
    public static function get_settings_sql($thquizid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($thquizid) {
        return array();
    }
}
