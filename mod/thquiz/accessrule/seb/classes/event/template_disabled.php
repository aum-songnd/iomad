...
class template_disabled extends base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'thquizaccess_seb_template';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('event:templatedisabled', 'thquizaccess_seb');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/thquiz/accessrule/seb/template.php', $params);
    }
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'thquizaccess_seb_template', 'restore' => 'thquizaccess_seb_template');
    }
