...
/**
 * Event for when access to a thquiz is prevented by this subplugin.
 *
...
class access_prevented extends base {
    ...
    public static function create_strict(access_manager $accessmanager, string $reason,
        ...
        return self::create([
            'userid' => $USER->id,
            'objectid' => $accessmanager->get_thquiz()->get_thquizid(),
            'courseid' => $accessmanager->get_thquiz()->get_courseid(),
            'context' => $accessmanager->get_thquiz()->get_context(),
            'other' => $other,
        ]);
    }
    ...
    public static function get_name() {
        return get_string('event:accessprevented', 'thquizaccess_seb');
    }
    ...
    public function get_description() {
        $description = "The user with id '$this->userid' has been prevented from accessing thquiz with id '$this->objectid' by the "
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'thquiz', 'restore' => 'thquiz');
    }
