...
namespace thquizaccess_seb\local\table;

use thquizaccess_seb\helper;
use thquizaccess_seb\template;
use thquizaccess_seb\template_controller;
...
class template_list extends \flexible_table {
    ...
    public function __construct($id = null) {
        ...
        parent::__construct('thquizaccess_seb' . $id);
        ...
        $this->define_headers([
            get_string('name', 'thquizaccess_seb'),
            get_string('description', 'thquizaccess_seb'),
            get_string('enabled', 'thquizaccess_seb'),
            get_string('used', 'thquizaccess_seb'),
            get_string('actions'),
        ]);
     ...
     * Display name column.
     *
     * @param \thquizaccess_seb\template $data Template for this row.
     * @return string
     */
     ...
     *
     * @param \thquizaccess_seb\template[] $records An array with records.
     */
