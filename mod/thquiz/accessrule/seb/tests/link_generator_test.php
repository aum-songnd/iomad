...
class link_generator_test extends \advanced_testcase {
    ...
    public function test_http_link_generated() {
        ...
        $thquiz = $this->getDataGenerator()->create_module('thquiz', ['course' => $course->id]);

        $this->assertEquals(
            "http://www.example.com/moodle/mod/thquiz/accessrule/seb/config.php?cmid=$thquiz->cmid",
            link_generator::get_link($thquiz->cmid, false, false));
    }
    ...
    public function test_https_link_generated() {
        ...
        $this->assertEquals(
            "https://www.example.com/moodle/mod/thquiz/accessrule/seb/config.php?cmid=$thquiz->cmid",
            link_generator::get_link($thquiz->cmid, false));
    }
    ...
    public function test_seb_link_generated() {
        ...
        $this->assertEquals(
            "seb://www.example.com/moodle/mod/thquiz/accessrule/seb/config.php?cmid=$thquiz->cmid",
            link_generator::get_link($thquiz->cmid, true, false));
    }
    ...
    public function test_sebs_link_generated() {
        ...
        $this->assertEquals(
            "sebs://www.example.com/moodle/mod/thquiz/accessrule/seb/config.php?cmid=$thquiz->cmid",
            link_generator::get_link($thquiz->cmid, true));
    }
