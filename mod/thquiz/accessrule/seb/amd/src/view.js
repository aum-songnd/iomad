...
/**
 * Manage the thquiz views.
 *
 * @module     thquizaccess_seb/view
...
const TEMPLATE = {
    LOADING: 'thquizaccess_seb/loading',
};
...
export const showValidationFailedModal = () => {
    ModalFactory.create({
        ...
        title: Str.get_string('sebkeysvalidationfailed', 'thquizaccess_seb'),
        body: Str.get_string('invalidkeys', 'thquizaccess_seb'),
        large: false,
    }).then((modal) => {
        modal.show();
