...
/**
 * Class to store the options for a {@link thquiz_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class thquiz_overview_options extends mod_thquiz_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('thquiz_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (thquiz_has_grades($this->thquiz)) {
            set_user_preference('thquiz_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/thquiz:regrade', 'mod/thquiz:deleteattempts'), context_module::instance($this->cm->id))
