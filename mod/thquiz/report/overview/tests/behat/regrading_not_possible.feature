...
Feature: Thquiz regrade when not possible
  ...
  Background:
    ...
    And the following "question categories" exist:
      ...
      | Activity module | thquiz1     | Test questions |
    ...
    And thquiz "Thquiz for testing regrading" contains the following questions:
      ...
      | MC       | 1    | 10.0    |
    And user "student" has attempted "Thquiz for testing regrading" with responses:
      | slot | response |
      |   1  | B        |
  ...
  Scenario: Try a regrade after the question has been edited to have a different number of choices
    ...
    When I am on the "Thquiz for testing regrading" "mod_thquiz > grades report" page
