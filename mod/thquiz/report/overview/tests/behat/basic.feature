@mod @mod_thquiz @thquiz @thquiz_overview
Feature: Basic use of the Grades report
  In order to easily get an overview of thquiz attempts
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | thquiz       | Thquiz 1 | Thquiz 1 description | C1     | thquiz1    | 2         |
    And the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext         |
      | Test questions   | description | Intro | Welcome to this thquiz |
    ...
    And thquiz "Thquiz 1" contains the following questions:
      ...
      | TF1      | 1    |         |
      | TF2      | 1    | 3.0     |
    And user "student1" has attempted "Thquiz 1" with responses:
      | slot | response |
      |   2  | True     |
      |   3  | False    |
    And user "student2" has attempted "Thquiz 1" with responses:
      | slot | response |
      |   2  | True     |
      |   3  | True     |
  ...
  Scenario: Using the Grades report
    ...
    When I am on the "Thquiz 1" "thquiz activity" page logged in as teacher1
    ...
    And I set the field "Attempts from" to "all users who have attempted the thquiz"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    # Check student2's grade
  ...
  Scenario: View custom user profile fields in the grades report
    ...
    And I am on the "Thquiz 1" "thquiz activity" page logged in as teacher1
    And I navigate to "Results" in current page administration
