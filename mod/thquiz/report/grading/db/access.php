...
/**
 * Capability definitions for the thquiz manual grading report.
 *
...
$capabilities = array(
    ...
    'thquiz/grading:viewstudentnames' => array(
        'captype' => 'read',
        ...
        'clonepermissionsfrom' => 'mod/thquiz:viewreports'
    ),
    ...
    'thquiz/grading:viewidnumber' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'legacy' => array(
            'teacher' => CAP_ALLOW,
