@mod @mod_thquiz @thquiz @thquiz_grading
Feature: Basic use of the Manual grading report
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | thquiz     | Thquiz 1 | C1     | thquiz1    | 1         | tging    |
      | thquiz     | Thquiz 2 | C1     | thquiz2    | 1         | tging    |
    And thquiz "Thquiz 1" contains the following questions:
      | question         | page |
      | Short answer 001 | 1    |

  Scenario: Manual grading report without attempts
    When I am on the "Thquiz 1" "mod_thquiz > Manual grading report" page logged in as "teacher1"
    Then I should see "Separate groups (Tutor groups)"
    And I should see "All participants"
    And I should see "Thquiz 1"
  ...
  Scenario: Manual grading report with attempts
    Given user "student1" has attempted "Thquiz 1" with responses:
      | slot | response |
      | 1    | Paris    |
  ...
  Scenario: Manual grading settings are remembered as user preferences
    ...
    And I press "Change options"
    And I log out
    And I am on the "Thquiz 1" "mod_thquiz > Manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
    And I click on "update grades" "link" in the "Short answer 001" "table_row"
  ...
  Scenario: A marker cannot access the report in separate group
    ...
    And user "student2" has attempted "Thquiz 1" with responses:
      | slot | response |
      | 1    | Duck     |
    When I am on the "Thquiz 1" "mod_thquiz > Manual grading report" page logged in as "marker"
    Then I should see "Thquiz 1"
  ...
  Scenario: Manual grading report with attempts to be graded
    ...
    And thquiz "Thquiz 2" contains the following questions:
      ...
      | Essay Q1 | 1    |
    And I log out
    When I am on the "Thquiz 2" "mod_thquiz > View" page logged in as "student1"
    ...
    And I am on the "Thquiz 2" "mod_thquiz > Manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
