...
/**
 * Standard plugin entry points of the thquiz statistics report.
 *
 ...
 * @package  thquiz_statistics
 * @category files
 * @param context $previewcontext the thquiz context
 ...
 */
function thquiz_statistics_question_preview_pluginfile($previewcontext, $questionid,
    ...
    require_capability('thquiz/statistics:view', $context);
