...
/**
 * Strings for component 'thquiz_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtothquizreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for thquiz, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for thquiz grades';
...
$string['getstatslocktimeoutdesc'] = 'How many seconds to wait for a lock when attempting to perform a statistics calculation for a thquiz. This setting primarily exists for testing, do not modify it unless you know what you are doing.';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the thquiz varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this thquiz are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a thquiz and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
$string['nogradedattempts'] = 'No attempts have been made at this thquiz, or all attempts have questions that need manual grading.';
...
$string['privacy:metadata'] = 'Although the Thquiz Statistics plugin has database tables, the data is aggregate data and does not describe a unique indidividual.';
...
$string['thquizinformation'] = 'Thquiz information';
$string['thquizname'] = 'Thquiz name';
$string['thquizoverallstatistics'] = 'Thquiz overall statistics';
$string['thquizstructureanalysis'] = 'Thquiz structure analysis';
...
$string['statsfor'] = 'Thquiz statistics (for {$a})';
