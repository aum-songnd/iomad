...
$PAGE->set_url('/mod/thquiz/comment.php', array('attempt' => $attemptid, 'slot' => $slot));
...
if (!$attemptobj->is_finished()) {
    throw new \moodle_exception('attemptclosed', 'thquiz');
}

// Check login and permissions.
require_login($attemptobj->get_course(), false, $attemptobj->get_cm());
$attemptobj->require_capability('mod/thquiz:grade');

// Print the page header.
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('manualgradequestion', 'thquiz', array(
...
<?php
echo '</form>';
$PAGE->requires->js_init_call('M.mod_thquiz.init_comment_popup', null, false, thquiz_get_js_module());
