...
/**
 * This page deals with processing responses during an attempt at a thquiz.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_thquiz_exception($attemptobj->get_thquizobj(),
...
if ($status == thquiz_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == thquiz_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
