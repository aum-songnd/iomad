...
class restore_override_test extends \restore_date_testcase {
    ...
    public function test_restore_overrides() {
        ...
        $thquizgen = $this->getDataGenerator()->get_plugin_generator('mod_thquiz');
        $thquiz = $thquizgen->create_instance(['course' => $course->id]);
        ...
        $DB->insert_record('thquiz_overrides', $groupoverride1);
        ...
        $DB->insert_record('thquiz_overrides', $groupoverride2);

        // Current thquiz overrides.
        $overrides = $DB->get_records('thquiz_overrides', ['thquiz' => $thquiz->id]);
        ...
        $DB->insert_record('thquiz_overrides', $useroverride);
        ...
        $overrides = $DB->get_records('thquiz_overrides', ['thquiz' => $newthquiz->id]);
