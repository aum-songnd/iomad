...
/**
 * Unit tests for the thquiz's own question bank view class.
 *
 * @package    mod_thquiz
 * @category   test
 ...
 */
class thquiz_question_bank_view_test extends \advanced_testcase {
    ...
    public function test_viewing_question_bank_should_not_load_individual_questions() {
        ...
        // Generate the view.
        $view = new custom_view($contexts, new \moodle_url('/'), $course, $cm, $thquiz);
        ob_start();
        $pagevars = [
            'qpage' => 0,
            'qperpage' => 20,
