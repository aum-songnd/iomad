@mod @mod_thquiz
Feature: Add a thquiz
  In order to evaluate students
  As a teacher
  I need to create a thquiz
  ...
  Background:
    ...
    And the following "activity" exists:
      ...
      | intro    | Test thquiz description |
      | section  | 1                     |
      | grade    | 10                    |
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I add a "True/False" question to the "Test thquiz name" thquiz with:
  ...
  Scenario: Add and configure small thquiz and perform an attempt as a student with Javascript enabled
  ...
  Scenario: Add and configure small thquiz and perform an attempt as a student with Javascript disabled
