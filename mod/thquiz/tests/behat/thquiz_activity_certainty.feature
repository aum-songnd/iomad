@mod @mod_thquiz
Feature: Set a thquiz with certainty-based marking
  As a teacher
  In order to set a a thquiz with certainty-based marking
  ...
  @javascript
  Scenario: Teacher can set a thquiz with certainty-based marking
    Given I am on the "Thquiz 1" "thquiz activity editing" page logged in as teacher1
    And I set the following fields to these values:
      | preferredbehaviour | immediatecbm |
    And I press "Save and return to course"
    And I am on the "Thquiz 1" "thquiz activity" page logged in as student1
    ...
    And the following should exist in the "thquizreviewsummary" table:
      | -1-              | -2-                                                                                                                 |
      | Marks            | 2.00/3.00                                                                                                           |
    ...
    # As teacher, confirm same thquiz contents
    ...
    And I am on the "Thquiz 1" "mod_thquiz > Grades report" page
