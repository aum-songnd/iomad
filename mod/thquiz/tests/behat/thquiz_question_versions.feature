@mod @mod_thquiz
Feature: Thquiz question versioning
  In order to manage question versions
  As a teacher
  I need to be able to choose which versions can be displayed in a thquiz
  ...
  Scenario: Appropriate question version should be displayed when not edited
    When I am on the "Thquiz 1" "mod_thquiz > Edit" page logged in as "teacher"
  ...
  Scenario: Appropriate question version displayed when later draft version exists
    ...
    And I am on the "Thquiz 1" "mod_thquiz > View" page
  ...
  Scenario: Creating a new question should have always latest in the version selection
    ...
    And I set the following fields to these values:
      ...
      | Question text   | Write 200 words about thquizzes. |
    And I press "id_submitbutton"
    And I should see "New essay" on thquiz page "1"
  ...
  Scenario: Adding a question from question bank should have always latest in the version selection
    ...
    Then I should see "Other question" on thquiz page "1"
  ...
  Scenario: Adding a question where all available versions are drafts should display a helpful message.
    Given thquiz "Thquiz 1" contains the following questions:
      | question       | page |
      | First question | 1    |
    And I am on the "Thquiz 1" "mod_thquiz > Question bank" page logged in as teacher
    And I set the field "question_status_dropdown" in the "First question" "table_row" to "Draft"
    When I am on the "Thquiz 1" "mod_thquiz > Edit" page
    Then I should see "This question is in draft status. To use it in the thquiz, go to the question bank and change the status to ready."
