...
Feature: Adding random questions to a thquiz based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | thquiz       | Thquiz 1 | Thquiz 1 for testing the Add random question form | C1     | thquiz1    |
  ...
  Scenario: A random question can be added to the thquiz
    Given I am on the "Thquiz 1" "mod_thquiz > Edit" page logged in as "teacher1"
    When I open the "last" add to thquiz menu
    And I follow "a random question"
    And I set the field "Tags" to "foo"
    And I press "Add random question"
    And I should see "Random (Questions Category 1, tags: foo)" on thquiz page "1"
  ...
  Scenario: A random question can be added to the thquiz by creating a new category
    Given I am on the "Thquiz 1" "mod_thquiz > Edit" page logged in as "teacher1"
    When I open the "last" add to thquiz menu
    And I follow "a random question"
    ...
    And I set the following fields to these values:
      ...
      | Parent category |  Top for Thquiz 1     |
    And I press "Create category and add random question"
    And I should see "Random (New Random category)" on thquiz page "1"
    And I click on "(See questions)" "link"
    Then I should see "Top for Thquiz 1"
