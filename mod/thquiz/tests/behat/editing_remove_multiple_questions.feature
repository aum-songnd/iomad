@mod @mod_thquiz
Feature: Edit thquiz page - remove multiple questions
  In order to change the layout of a thquiz I built efficiently
  As a teacher
  ...
  Scenario: Delete selected question using select multiple items feature.
    ...
    And I should see "This thquiz is open"
    ...
    Then I should see "Question A" on thquiz page "1"
    And I should see "Question B" on thquiz page "1"
    And I should not see "Question C" on thquiz page "2"
  ...
  # Confirm the starting point.
    Then I should see "Question A" on thquiz page "1"
    And I should see "Question B" on thquiz page "2"
    And I should see "Question C" on thquiz page "2"
    And I should see "Total of marks: 3.00"
    And I should see "Questions: 3"
    And I should see "This thquiz is open"
  ...
  # Delete first question in first page. Page contains multiple questions. No reordering.
    ...
    Then I should not see "Question A" on thquiz page "1"
    And I should see "Question B" on thquiz page "1"
  ...
  @javascript
  Scenario: Can delete the last question in a thquiz.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And thquiz "Thquiz 1" contains the following questions:
  ...
  Scenario: Delete all questions by checking select all.
    ...
    Then I should not see "Question A" on thquiz page "1"
    And I should not see "Question B" on thquiz page "1"
    And I should not see "Question C" on thquiz page "2"
  ...
  Scenario: Delete multiple questions from sections
    ...
    Then I should see "Question A" on thquiz page "1"
    And I should see "Question B" on thquiz page "2"
    And I should see "Question D" on thquiz page "3"
  ...
  Scenario: Delete multiple random questions from sections.
    ...
    Then I should see "Random (Test questions)" on thquiz page "1"
    And I should not see "Random (Test questions)" on thquiz page "2"
    And I should not see "Random (Test questions)" on thquiz page "3"
  ...
  Scenario: Delete all random questions by checking select all.
    ...
    And I click on "Yes" "button" in the "Confirm" "dialogue"
     # To make sure question is deleted completely.
    And I reload the page
    Then I should not see "Random (Test questions)" on thquiz page "1"
    And I should not see "Random (Test questions)" on thquiz page "2"
    And I should not see "Random (Test questions)" on thquiz page "3"
    And I should see "Total of marks: 0.00"
    And I should see "Questions: 0"
