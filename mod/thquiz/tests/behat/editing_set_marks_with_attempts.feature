@mod @mod_thquiz
Feature: Edit thquiz marks with attempts
  In order to create a thquiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit thquiz page (even after the thquiz has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | thquiz       | Thquiz 1 | C1     | thquiz1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I add a "True/False" question to the "Thquiz 1" thquiz with:
    ...
    And I add a "True/False" question to the "Thquiz 1" thquiz with:
      ...
      | Default mark  | 3.0             |
    And I log out
    And I am on the "Thquiz 1" "mod_thquiz > View" page logged in as "student1"
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the thquiz settings say it should be.
    ...
    When I am on the "Thquiz 1" "thquiz activity editing" page
