...
Feature: View activity completion in the thquiz activity
  In order to have visibility of thquiz completion requirements
  As a student
  I need to be able to view my thquiz completion progress
  ...
  Scenario Outline: View automatic completion items as a student
    ...
    And the "View" completion condition of "Test thquiz name" is displayed as "done"
    And the "Make attempts: 1" completion condition of "Test thquiz name" is displayed as "todo"
    ...
    And I follow "Test thquiz name"
    And the "View" completion condition of "Test thquiz name" is displayed as "done"
    And the "Make attempts: 1" completion condition of "Test thquiz name" is displayed as "done"
