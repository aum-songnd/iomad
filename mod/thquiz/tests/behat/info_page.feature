@mod @mod_thquiz
Feature: Display of information before starting a thquiz
  As a student
  In order to start a thquiz with confidence
  I need information about the thquiz settings before I start an attempt
  ...
  Scenario: Check the pass grade is displayed
    Given the following "activities" exist:
      ...
      | thquiz       | Thquiz 1 | Thquiz 1 description | C1     | thquiz1    | 60.00     |
