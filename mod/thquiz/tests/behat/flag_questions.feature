@mod @mod_thquiz
Feature: Flag thquiz questions
  As a student
  In order to flag a thquiz questions
  ...
  @javascript
  Scenario: Flag a thquiz during and after thquiz attempt
    Given I am on the "Thquiz 1" "thquiz activity" page logged in as student1
    ...
    And I am on the "Thquiz 1" "mod_thquiz > Grades report" page logged in as teacher1
    And "Flagged" "icon" should exist in the "Student 1" "table_row"
    And I am on the "Thquiz 1" "mod_thquiz > Responses report" page
    And "Flagged" "icon" should exist in the "Student 1" "table_row"
