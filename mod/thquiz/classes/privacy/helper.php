...
/**
 * Privacy Subsystem helper for mod_thquiz.
 *
 * @package    mod_thquiz
...
class helper {
    /**
     * Determine the subcontext for the specified thquiz attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_thquiz_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
