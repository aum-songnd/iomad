...
namespace mod_thquiz\question\bank\filter;

use core_question\local\bank\question_version_status;

/**
 * A custom filter condition helper for thquiz to select question categories.
 *
 * This is required as thquiz will only use ready questions and the count should show according to that.
 *
 * @package    mod_thquiz
 * @category   question
