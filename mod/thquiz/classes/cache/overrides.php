...
/**
 * Cache data source for the thquiz overrides.
 *
 * @package   mod_thquiz
...
namespace mod_thquiz\cache;

use cache_definition;

/**
 * Class thquiz_overrides
 *
 * @package   mod_thquiz
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class overrides implements \cache_data_source {
    ...
    public function load_for_cache($key) {
        ...
        [$thquizid, $ug, $ugid] = explode('_', $key);
        $thquizid = (int) $thquizid;
        ...
        switch ($ug) {
            ...
            case 'g':
                ...
                $override = $DB->get_record(
                    'thquiz_overrides',
                    ['thquiz' => $thquizid, 'groupid' => $groupid],
                    'timeopen, timeclose, timelimit, attempts, password'
                );
                break;
            default:
