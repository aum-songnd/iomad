...
/**
 * The mod_thquiz attempt viewed event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_thquiz');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has viewed page '$page' of the attempt with id " .
            "'$this->objectid' belonging to the user with id '$this->relateduserid' for the thquiz " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/thquiz/review.php', [
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'thquiz', 'continue attempt', 'review.php?attempt=' . $this->objectid,
