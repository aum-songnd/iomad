...
/**
 * The mod_thquiz attempt became overdue event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The thquiz attempt with id '$this->objectid' belonging to the thquiz with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventthquizattempttimelimitexceeded', 'mod_thquiz');
    }
