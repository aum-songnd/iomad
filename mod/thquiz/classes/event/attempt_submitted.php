...
/**
 * The mod_thquiz attempt submitted event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventthquizattemptsubmitted', 'mod_thquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'thquiz_attempt_submitted';
    }
