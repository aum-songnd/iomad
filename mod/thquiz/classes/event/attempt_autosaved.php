...
/**
 * The mod_thquiz attempt auto-saved event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz attempt auto-saved event class.
 *
...
class attempt_autosaved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptautosaved', 'mod_thquiz');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' is working on page " .
            ...
            "with id '$this->objectid' for the thquiz with course module id '$this->contextinstanceid', " .
