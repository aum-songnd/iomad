...
/**
 * The mod_thquiz slots created event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz slot created event class.
 *
...
class slot_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventslotcreated', 'mod_thquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created a new slot with id '{$this->objectid}' " .
            ...
            "of the thquiz with course module id '$this->contextinstanceid'.";
    }
