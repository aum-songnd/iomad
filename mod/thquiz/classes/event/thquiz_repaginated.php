...
/**
 * The mod_thquiz thquiz re-paginated event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz thquiz re-paginated event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class thquiz_repaginated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventthquizrepaginated', 'mod_thquiz');
    }

    public function get_description() {
        return "The user with id '$this->userid' re-paginated the thquiz with course module id '$this->contextinstanceid' " .
    ...
    public static function get_objectid_mapping() {
        return ['db' => 'thquiz', 'restore' => 'thquiz'];
    }
