...
/**
 * The mod_thquiz slots require previous updated event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz slot require previous updated event class.
 *
...
class slot_requireprevious_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventslotrequirepreviousupdated', 'mod_thquiz');
    }

    public function get_description() {
        return "The user with id '$this->userid' updated the slot with id '{$this->objectid}' " .
            "belonging to the thquiz with course module id '$this->contextinstanceid'. " .
