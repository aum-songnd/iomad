...
/**
 * The mod_thquiz thquiz grade updated event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz thquiz grade updated event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class thquiz_grade_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventthquizgradeupdated', 'mod_thquiz');
    }

    public function get_description() {
        return "The user with id '$this->userid' updated the maximum grade for the thquiz with " .
