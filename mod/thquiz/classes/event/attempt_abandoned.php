...
/**
 * The mod_thquiz attempt abandoned event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int thquizid: (optional) id of the thquiz.
 * }
 *
 * @package    mod_thquiz
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the thquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventthquizattemptabandoned', 'mod_thquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'thquiz_attempt_abandoned';
    }
