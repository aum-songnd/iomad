...
/**
 * The mod_thquiz slots deleted event.
 *
 * @package    mod_thquiz
...
/**
 * The mod_thquiz slot deleted event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int thquizid: the id of the thquiz.
 *      - int slotnumber: the slot number in thquiz.
 * }
 *
 * @package    mod_thquiz
 * @copyright  2021 The Open University
