...
/**
 * Strings for component 'thquiz', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_thquiz
...
$string['accessnoticesheader'] = 'You can preview this thquiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have thquizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the thquiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the thquiz. This means that different students are likely to get a different selection of questions, and when a thquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any thquiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your thquiz over on the other side of this page.</p>';
...
$string['addquestionstothquiz'] = 'Add questions to current thquiz';
...
$string['addrandomquestiontothquiz'] = 'Add a random question to thquiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstothquiz'] = 'Add selected questions to the thquiz';
$string['addselectedtothquiz'] = 'Add selected to thquiz';
$string['addtothquiz'] = 'Add to thquiz';
...
$string['attempterror'] = 'You are not allowed to attempt this thquiz at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid thquiz attempt ID';
$string['attempterrorcontentchange'] = 'This thquiz preview no longer exists. (When a thquiz is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This thquiz attempt no longer exists.';
...
$string['attemptthquiznow'] = 'Attempt thquiz now';
$string['attemptthquiz'] = 'Attempt thquiz';
...
$string['attemptsdeleted'] = 'Thquiz attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during thquiz attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtothquiz'] = 'Back to thquiz editing';
...
* The thquiz will only start if the student has a JavaScript-enabled web-browser
* The thquiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this thquiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the thquiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this thquiz. The thquiz is set to be graded out of {$a->grade}, but none of the questions in the thquiz have a grade. This can be fixed on the \'Edit thquiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this thquiz. The thquiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this thquiz. The thquiz has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire thquiz attempt having to be submitted and another attempt started. This option is useful for practice thquizzes.
...
$string['closebeforeopen'] = 'Could not update the thquiz. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark thquiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the thquiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the thquiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the thquiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a thquiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the thquiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new thquiz. You can also configure which thquiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the thquiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the thquiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the thquiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during thquiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the thquiz.';
$string['configrequiresubnet'] = 'Students can only attempt the thquiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a thquiz attempt or look at the thquiz reports.';
$string['configshowblocks'] = 'Show blocks during thquiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this thquiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for thquizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for thquizzes in seconds. 0 mean no time limit.';
...
$string['continueattemptthquiz'] = 'Continue your attempt';
...
$string['countdownfinished'] = 'The thquiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The thquiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to thquiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the thquiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the thquiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the thquiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/thquiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new thquiz attempt will contain the results of the previous attempt. This allows a thquiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingthquiz'] = 'Editing thquiz';
$string['editingthquiz_help'] = 'When creating a thquiz, the main concepts are:

* The thquiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the thquiz and different students can get different questions';
$string['editingthquiz_link'] = 'mod/thquiz/edit';
$string['editingthquizx'] = 'Editing thquiz: {$a}';
...
$string['editthquiz'] = 'Edit thquiz';
$string['editthquizquestions'] = 'Edit thquiz questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->thquizname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this thquiz at {$a->thquizurl}.';
$string['emailconfirmbodyautosubmit'] = 'Hi {$a->username},

The time for the thquiz \'{$a->thquizname}\' in the course \'{$a->coursename}\' expired. Your answers were submitted automatically at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this thquiz at {$a->thquizurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->thquizname}\'';
$string['emailconfirmautosubmitsmall'] = 'Thank you for submitting your answers to \'{$a->thquizname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->thquizname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->thquizname}\' ({$a->thquizurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->thquizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->thquizname}. See {$a->thquizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->thquizname}';
$string['emailmanualgradedbody'] = 'Hi {$a->studentname},

Your answers to \'{$a->thquizname}\' in course \'{$a->coursename}\' at {$a->attempttimefinish} have now been graded.

You will be able to view your score and feedback by visiting \'{$a->thquizurl}\' and reviewing your attempt.';

$string['emailmanualgradedsubject'] = 'Your attempt at {$a->thquizname} has been graded';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->thquizname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->thquizname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->thquizname}';
$string['empty'] = 'Empty';
...
$string['eventattemptautosaved'] = 'Thquiz attempt auto-saved';
$string['eventattemptdeleted'] = 'Thquiz attempt deleted';
$string['eventattemptmanualgradingcomplete'] = 'Thquiz attempt manual grading complete';
$string['eventattemptpreviewstarted'] = 'Thquiz attempt preview started';
$string['eventattemptquestionrestarted'] = 'Thquiz attempt question restarted';
$string['eventattemptreviewed'] = 'Thquiz attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Thquiz attempt summary viewed';
$string['eventattemptupdated'] = 'Thquiz attempt updated';
$string['eventattemptviewed'] = 'Thquiz attempt viewed';
$string['eventeditpageviewed'] = 'Thquiz edit page viewed';
$string['eventoverridecreated'] = 'Thquiz override created';
$string['eventoverridedeleted'] = 'Thquiz override deleted';
$string['eventoverrideupdated'] = 'Thquiz override updated';
...
$string['eventthquizattemptabandoned'] = 'Thquiz attempt abandoned';
$string['eventthquizattempttimelimitexceeded'] = 'Thquiz attempt time limit exceeded';
$string['eventthquizattemptregraded'] = 'Thquiz attempt regraded';
$string['eventthquizattemptstarted'] = 'Thquiz attempt started';
$string['eventthquizattemptsubmitted'] = 'Thquiz attempt submitted';
$string['eventthquizgradeupdated'] = 'Thquiz grade updated';
$string['eventthquizrepaginated'] = 'Thquiz re-paginated';
$string['eventreportviewed'] = 'Thquiz report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the thquiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the thquiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the thquiz. You have to make a trade-off based on how much you trust the performance of your server during thquizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final thquiz grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Thquiz grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->thquizgrade}.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this thquiz has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt thquizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a thquiz.';
...
$string['indicator:cognitivedepth'] = 'Thquiz cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Thquiz activity.';
$string['indicator:cognitivedepthdef'] = 'Thquiz cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Thquiz activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Thquiz social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Thquiz activity.';
$string['indicator:socialbreadthdef'] = 'Thquiz social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Thquiz activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new thquiz, provide this many blank overall feedback boxes. Once the thquiz has been created, the form shows the number of fields required for the number of feedbacks in the thquiz. The setting must be at least 1.';
...
$string['invalidthquizid'] = 'Invalid thquiz ID';
...
$string['legacythquizaccessrulescron'] = 'Legacy cron thquiz access rules';
$string['legacythquizreportscron'] = 'Legacy cron thquiz reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in thquiz';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->thquiz} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your thquiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own thquiz submissions';
$string['messageprovider:attempt_grading_complete'] = 'Notification that your attempt has been graded';
$string['messageprovider:submission'] = 'Notification of your students\' thquiz submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'Thquiz';
$string['modulename_help'] = 'The thquiz activity enables a teacher to create thquizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the thquiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/thquiz/view';
$string['modulenameplural'] = 'Thquizzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the thquiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the thquiz';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer thquizzes it makes sense to stretch the thquiz over several pages by limiting the number of questions per page. When adding questions to the thquiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this thquiz';
...
$string['nogradewarning'] = 'This thquiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the thquiz settings.';
...
$string['noquestionsinthquiz'] = 'There are no questions in this thquiz.';
...
$string['noreview'] = 'You are not allowed to review this thquiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this thquiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This thquiz is currently not available to your students.';
...
$string['notifyattemptsgradedtask'] = 'Send thquiz attempt graded notifications';
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the thquiz module. As a work around, set a time limit for the whole thquiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this thquiz';
...
$string['openafterclose'] = 'Could not update the thquiz. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Thquiz open and close dates updated';
...
$string['orderingthquiz'] = 'Order and paging';
$string['orderingthquizx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a thquiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the thquiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their thquiz attempt before the time expires. If the student is actively working on the thquiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/thquiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this thquiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->thquiz} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overridesforthquiz'] = 'Settings overrides: {$a}';
$string['overridesnoneforgroups'] = 'No group settings overrides have been created for this thquiz.';
$string['overridesnoneforusers'] = 'No user settings overrides have been created for this thquiz.';
...
$string['overrideusereventname'] = '{$a->thquiz} - Override';
$string['pageshort'] = 'P';
$string['page-mod-thquiz-x'] = 'Any thquiz module page';
$string['page-mod-thquiz-attempt'] = 'Attempt thquiz page';
$string['page-mod-thquiz-edit'] = 'Edit thquiz page';
$string['page-mod-thquiz-report'] = 'Any thquiz report page';
$string['page-mod-thquiz-review'] = 'Review thquiz attempt page';
$string['page-mod-thquiz-summary'] = 'Thquiz attempt summary page';
$string['page-mod-thquiz-view'] = 'Thquiz information page';
...
$string['pluginadministration'] = 'Thquiz administration';
$string['pluginname'] = 'Thquiz';
$string['popup'] = 'Show thquiz in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the thquiz in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this thquiz in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewthquiz'] = 'Preview {$a}';
$string['previewthquizstart'] = 'Preview thquiz';
$string['previewthquiznow'] = 'Preview thquiz now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The thquiz activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:thquiz'] = 'The thquiz activity makes use of thquiz reports.';
$string['privacy:metadata:thquiz_attempts'] = 'Details about each attempt on a thquiz.';
$string['privacy:metadata:thquiz_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:thquiz_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:thquiz_attempts:gradednotificationsenttime'] = 'The time the user was notified that manual grading of their attempt was complete';
$string['privacy:metadata:thquiz_attempts:preview'] = 'Whether this is a preview of the thquiz.';
$string['privacy:metadata:thquiz_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:thquiz_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:thquiz_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:thquiz_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:thquiz_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:thquiz_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:thquiz_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:thquiz_grades'] = 'Details about the overall grade for this thquiz.';
$string['privacy:metadata:thquiz_grades:grade'] = 'The overall grade for this thquiz.';
$string['privacy:metadata:thquiz_grades:thquiz'] = 'The thquiz that was graded.';
$string['privacy:metadata:thquiz_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:thquiz_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:thquiz_overrides'] = 'Details about overrides for this thquiz';
$string['privacy:metadata:thquiz_overrides:thquiz'] = 'The thquiz with override information';
$string['privacy:metadata:thquiz_overrides:timeclose'] = 'The new close time for the thquiz.';
$string['privacy:metadata:thquiz_overrides:timelimit'] = 'The new time limit for the thquiz.';
$string['privacy:metadata:thquiz_overrides:timeopen'] = 'The new open time for the thquiz.';
$string['privacy:metadata:thquiz_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:thquizaccess'] = 'The thquiz activity makes use of thquiz access rules.';
...
$string['questiondraftonly'] = 'The question {$a} is in draft status. To use it in the thquiz, go to the question bank and change the status to ready.';
$string['questiondraftwillnotwork'] = 'This question is in draft status. To use it in the thquiz, go to the question bank and change the status to ready.';
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->thquiznames}<br />The question will not be deleted from these thquizzes but only from the category list.';
...
$string['questionsinthisthquiz'] = 'Questions in this thquiz';
...
$string['thquiz:addinstance'] = 'Add a new thquiz';
$string['thquiz:attempt'] = 'Attempt thquizzes';
$string['thquizavailable'] = 'The thquiz is available until: {$a}';
$string['thquizclose'] = 'Close the thquiz';
$string['thquizclosed'] = 'This thquiz closed on {$a}';
$string['thquizcloses'] = 'Thquiz closes';
$string['thquizeventcloses'] = '{$a} closes';
$string['thquizcloseson'] = 'This thquiz will close on {$a}.';
$string['thquiz:deleteattempts'] = 'Delete thquiz attempts';
$string['thquiz:emailconfirmsubmission'] = 'Receive confirmation of your own thquiz submissions';
$string['thquiz:emailnotifysubmission'] = 'Receive notification of your students\' thquiz submissions';
$string['thquiz:emailnotifyattemptgraded'] = 'Receive notification when your attempt has been graded';
$string['thquiz:emailwarnoverdue'] = 'Receive warning when your thquiz attempt becomes overdue';
$string['thquiz:grade'] = 'Grade thquizzes manually';
$string['thquiz:ignoretimelimits'] = 'Ignore thquiz time limit';
$string['thquizisclosed'] = 'This thquiz is closed';
$string['thquizisopen'] = 'This thquiz is open';
$string['thquizisclosedwillopen'] = 'Thquiz closed (opens {$a})';
$string['thquizisopenwillclose'] = 'Thquiz open (closes {$a})';
$string['thquiz:manage'] = 'Manage thquizzes';
$string['thquiz:manageoverrides'] = 'Manage thquiz settings overrides';
$string['thquiz:viewoverrides'] = 'View thquiz settings overrides';
$string['thquiznavigation'] = 'Thquiz navigation';
$string['thquizopen'] = 'Open the thquiz';
$string['thquizeventopens'] = '{$a} opens';
$string['thquizopenclose'] = 'Open and close dates';
$string['thquizopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['thquizopenclose_link'] = 'mod/thquiz/timing';
$string['thquizopened'] = 'This thquiz is open.';
$string['thquizopenedon'] = 'This thquiz opened on {$a}';
$string['thquizopens'] = 'Thquiz opens';
$string['thquizopenwillclose'] = 'This thquiz is open, will close on {$a} at';
$string['thquizordernotrandom'] = 'Order of thquiz not shuffled';
$string['thquizorderrandom'] = '* Order of thquiz is shuffled';
$string['thquiz:preview'] = 'Preview thquizzes';
$string['thquiz:regrade'] = 'Regrade thquiz attempts';
$string['thquizreport'] = 'Thquiz report';
$string['thquiz:reviewmyattempts'] = 'Review your own attempts';
$string['thquizsettings'] = 'Thquiz settings';
$string['thquiz:view'] = 'View thquiz information';
$string['thquiz:viewreports'] = 'View thquiz reports';
$string['thquiztimer'] = 'Thquiz Timer';
$string['thquizwillopen'] = 'This thquiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole thquiz to be graded.  Are you sure you want to continue?';
$string['reattemptthquiz'] = 'Re-attempt thquiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this thquiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingthquiz'] = 'Regrading thquiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallthquizattempts'] = 'Delete all thquiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the thquiz';
$string['reportuserswith'] = 'enrolled users who have attempted the thquiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the thquiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the thquiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the thquiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Thquiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) thquiz, to ensure that only people in a certain location can access the thquiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to thquiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after thquiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while thquiz is open';
$string['reviewclosed'] = 'After the thquiz is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->thquiz} by {$a->user}';
$string['reviewopen'] = 'Later, while the thquiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a thquiz attempt or look at the thquiz reports.
...
**Later, while the thquiz is still open** settings apply after this, and before the thquiz close date.

**After the thquiz is closed** settings apply after the thquiz close date has passed. If the thquiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current thquiz attempt.';
...
$string['savethquiz'] = 'Save this whole thquiz';
...
$string['search:activity'] = 'Thquiz - activity information';
...
$string['showblocks'] = 'Show blocks during thquiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during thquiz attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the thquiz is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the thquiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonthquiz'] = 'Specified question is not on the specified thquiz';
...
$string['subneterror'] = 'Sorry, this thquiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this thquiz.';
$string['subnetnotice'] = 'This thquiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_thquiz'] = 'Report';
$string['subplugintype_thquiz_plural'] = 'Reports';
$string['subplugintype_thquizaccess'] = 'Access rule';
$string['subplugintype_thquizaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the thquiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the thquiz since you have not passed the time delay before attempting another thquiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial thquiz page and a countdown timer is displayed in the thquiz navigation block.';
$string['timelimit_link'] = 'mod/thquiz/timing';
$string['timelimitexeeded'] = 'Sorry! Thquiz time limit exceeded!';
...
$string['updateoverdueattemptstask'] = 'Updating overdue thquiz attempts';
$string['updatesettings'] = 'Update thquiz settings';
$string['updatethquizslotswithrandomxofy'] = 'Updating thquiz slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the thquiz module will perform an extensive change of the thquiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingthquizattempts'] = 'Upgrading thquiz attempts: thquiz {$a->done}/{$a->outof} (Thquiz id {$a->info})';
$string['upgradingveryoldthquizattempts'] = 'Upgrading very old thquiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this thquiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} thquiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this thquiz';
$string['yourfinalgradeis'] = 'Your final grade for this thquiz is {$a}.';
$string['questionversion'] = 'v{$a}';
$string['questionversionlatest'] = 'v{$a} (latest)';
$string['alwayslatest'] = 'Always latest';
$string['gobacktothquiz'] = 'Go back';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the thquiz settings) or higher.';
$string['completiondetail:passgrade'] = 'Receive a pass grade';
$string['gradetopassnotset'] = 'This thquiz does not yet have a grade to pass set. It may be set in the Grade section of the thquiz settings.';
$string['basicideasofthquiz'] = 'The basic ideas of thquiz-making';
$string['list_quiz_cluster'] = 'Quiz cluster configuration';
$string['quiz_listening'] = 'Choose a listening test';
$string['quiz_reading'] = 'Choose a reading test';
$string['quiz_writing'] = 'Choose a writing test';
$string['quiz_speaking'] = 'Choose a speaking test';
$string['id'] = 'ID';
$string['originalquiz'] = 'Original Quiz';
$string['th_module'] = 'TH Quiz Module';
$string['attemptid'] = 'Attempt ID';
$string['fullname'] = 'Full Name';
$string['trackingmanager'] = 'Quản lý làm bài';