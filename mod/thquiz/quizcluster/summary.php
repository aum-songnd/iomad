...
$PAGE->set_url('/mod/thquiz/quizcluster/summary.php', array('attempt' => $attemptid, 'cmid' => $cmid, 'cm_cluster_id' => $cm_cluster_id));
...
if ($attemptobj->is_finished()) {
    redirect($attemptobj->review_cluster_url($cm_cluster_id));
}
...
$navbc = $attemptobj->get_navigation_panel_cluster($output, $cm_cluster_id, 'thquiz_attempt_nav_panel', -1);
...
// Display the page.
echo $output->summary_cluster_page($attemptobj, $displayoptions, $cm_cluster_id);
