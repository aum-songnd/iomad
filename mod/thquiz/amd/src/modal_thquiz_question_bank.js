 ...
 *
 * @module     mod_thquiz/modal_thquiz_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_THQUIZ_CONTAINER: 'td.addtothquizaction',
        ANCHOR: 'a[href]',
     ...
     */
    var ModalThquizQuestionBank = function(root) {
    ...
    ModalThquizQuestionBank.TYPE = 'mod_thquiz-thquiz-question-bank';
    ModalThquizQuestionBank.prototype = Object.create(Modal.prototype);
    ModalThquizQuestionBank.prototype.constructor = ModalThquizQuestionBank;
     ...
     * @param {int} id
     */
    ModalThquizQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalThquizQuestionBank.prototype.getContextId = function() {
        return this.contextId;
    };

    /**
     * Set the id of the page that the question should be added to
     * when the user clicks the add to thquiz link.
     *
     * @method setAddOnPageId
     * @param {int} id
     */
    ModalThquizQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalThquizQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalThquizQuestionBank.prototype.show = function() {
     ...
     *
     * @method handleAddToThquizEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalThquizQuestionBank.prototype.handleAddToThquizEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalThquizQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalThquizQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     *      - The thquiz category select box
     ...
     */
    ModalThquizQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalThquizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('submit', SELECTORS.ADD_QUESTIONS_FORM, function(e) {
            // If the user clicks on the "Add selected questions to the thquiz" button to add some questions to the page
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to thquiz link.
            if (anchorElement.closest(SELECTORS.ADD_TO_THQUIZ_CONTAINER).length) {
                this.handleAddToThquizEvent(e, anchorElement);
                return;
            }
    ...
    if (!registered) {
        ModalRegistry.register(
            ModalThquizQuestionBank.TYPE,
            ModalThquizQuestionBank,
            'core/modal'
        );
    ...
    return ModalThquizQuestionBank;
});
