...
/**
 * Render the question slot template for each question in the thquiz edit view.
 *
 * @module     mod_thquiz/question_slot
...
const setQuestionVersion = (slotId, newVersion) => fetchMany([{
    methodname: 'mod_thquiz_set_question_version',
    args: {
        slotid: slotId,
...
const registerEventListeners = () => {
    document.addEventListener('change', e => {
        if (!e.target.matches('[data-action="mod_thquiz-select_slot"][data-slot-id]')) {
            return;
        }
