...
/**
 * A javascript module to handle submission confirmation for thquiz.
 *
 * @module    mod_thquiz/submission_confirmation
...
const SELECTOR = {
    attemptSubmitButton: '.path-mod-thquiz .btn-finishattempt button',
    attemptSubmitForm: 'form#frm-finishattempt',
};

const TEMPLATES = {
    submissionConfirmation: 'mod_thquiz/submission_confirmation',
};
...
export const init = (unAnsweredQuestions) => {
    ...
    Prefetch.prefetchStrings('thquiz', ['submitallandfinish', 'submission_confirmation']);
