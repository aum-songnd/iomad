 ...
 *
 * This is also responsible for opening the pop-up window, if the thquiz requires to be in one.
 *
 * @module    mod_thquiz/preflightcheck
...
define(['jquery', 'core/yui', 'core_form/changechecker'], function($, Y, FormChangeChecker) {
    ...
    /**
     * @alias module:mod_thquiz/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the thquiz should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_thquiz_preflight_popup']
                    });
                ...
                if (popupoptions) {
                    Y.one(finalStartButton).on('click', t.launchThquizPopup, t, popupoptions);
                }
            });
        },
        ...
        /**
         * Event handler for the thquiz start attempt button.
         * @param {Event} e the event being responded to
         * @param {Object} popupoptions
         */
        launchThquizPopup: function(e, popupoptions) {
            e.halt();
