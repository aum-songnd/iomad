YUI.add('moodle-mod_thquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_thquiz-questionchooser'
});

M.mod_thquiz = M.mod_thquiz || {};
M.mod_thquiz.init_questionchooser = function() {
    M.mod_thquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_thquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_thquiz-util", "querystring-parse"]});
