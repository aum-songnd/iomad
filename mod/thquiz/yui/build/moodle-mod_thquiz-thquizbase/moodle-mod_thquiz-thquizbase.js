YUI.add('moodle-mod_thquiz-thquizbase', function (Y, NAME) {

/**
 * The thquizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_thquiz-thquizbase
 */
var THQUIZBASENAME = 'mod_thquiz-thquizbase';

var THQUIZBASE = function() {
    THQUIZBASE.superclass.constructor.apply(this, arguments);
};
...
M.mod_thquiz.thquizbase = M.mod_thquiz.thquizbase || new THQUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_thquiz.edit = M.mod_thquiz.edit || {};
 ...
 */
M.mod_thquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_thquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
