...
/**
 * Event triggered when company is created via API.
 *
...
class th_company_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "Create company {$name}({$company_code}).";
    }
