 ...
 *
 * @module     qtype_thddwtos/thddwtos
...
define(['jquery', 'core/dragdrop', 'core/key_codes'], function($, dragDrop, keys) {
    ...
    function DragDropToTextQuestion(containerId, readOnly) {
        ...
        if (readOnly) {
            this.getRoot().addClass('qtype_thddwtos-readonly');
        }
    ...
    DragDropToTextQuestion.prototype.animateTo = function(drag, target) {
        ...
        M.util.js_pending('qtype_thddwtos-animate-' + thisQ.containerId);
        ...
        drag.animate(
            ...
            },
            {
                duration: 'fast',
                    ...
                    $('body').trigger('qtype_thddwtos-dragmoved', [drag, target, thisQ]);
                    M.util.js_complete('qtype_thddwtos-animate-' + thisQ.containerId);
                }
            }
        );
    };
    ...
    var questionManager = {
        ...
        setupEventHandlers: function() {
            ...
            questionManager.addEventHandlersToDrag($('.que.thddwtos:not(.qtype_thddwtos-readonly) span.draghome'));
            $('body')
                .on('keydown',
                    '.que.thddwtos:not(.qtype_thddwtos-readonly) span.drop',
                    questionManager.handleKeyPress)
                .on('keydown',
                    '.que.thddwtos:not(.qtype_thddwtos-readonly) span.draghome.placed:not(.beingdragged)',
                    questionManager.handleKeyPress)
                .on('qtype_thddwtos-dragmoved', questionManager.handleDragMoved);
        },
        ...
        getQuestionForEvent: function(e) {
            var containerId = $(e.currentTarget).closest('.que.thddwtos').attr('id');
    ...
    /**
     * @alias module:qtype_thddwtos/thddwtos
     */
    return {
        /**
