...
require_once($CFG->dirroot . '/question/type/thddwtos/edit_thddwtos_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_thddwtos_edit_form_test extends advanced_testcase {
    /**
     * Helper method.
     *
    ...
    protected function get_form($classname) {
        ...
        $fakequestion->qtype = 'thddwtos'; // Does not actually matter if this is wrong.
    ...
    public function test_number_of_choice_groups() {
        list($form) = $this->get_form('qtype_thddwtos_edit_form');
        // Use reflection to get the protected property we need.
        $property = new ReflectionProperty('qtype_thddwtos_edit_form', '_form');
    ...
    public function test_choices_validation() {
        list($form, $category) = $this->get_form('qtype_thddwtos_edit_form');
