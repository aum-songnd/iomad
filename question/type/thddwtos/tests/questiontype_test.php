...
require_once($CFG->dirroot . '/question/type/thddwtos/tests/helper.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_thddwtos_test extends question_testcase {
    /** @var qtype_thddwtos instance of the question type class to test. */
    protected $qtype;

    protected function setUp(): void {
        $this->qtype = question_bank::get_qtype('thddwtos');;
    }
     ...
     * {@link qtype_thddwtos_test_helper::make_thddwtos_question_fox()}.
     */
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'thddwtos');
    }
    ...
    public function test_save_question() {
        ...
        $fromform = test_question_maker::get_question_form_data('thddwtos', 'missingchoiceno');
        $fromform->category = $category->id . ',' . $syscontext->id;

        $question = new stdClass();
        $question->category = $category->id;
        $question->qtype = 'thddwtos';
    ...
    public function test_initialise_question_instance() {
        ...
        $expected = test_question_maker::make_question('thddwtos');
    ...
    <hint>
      ...
      <clearwrong />
        ...
        $q = $importer->try_importing_using_qtypes(
                $xmldata['question'], null, null, 'thddwtos');

        $expectedq = new stdClass();
        $expectedq->qtype = 'thddwtos';
