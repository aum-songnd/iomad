 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_thddwtos_question_test extends basic_testcase {

    public function test_get_question_summary() {
        $dd = test_question_maker::make_question('thddwtos');
    ...
    public function test_get_question_summary_maths() {
        $dd = test_question_maker::make_question('thddwtos', 'maths');
