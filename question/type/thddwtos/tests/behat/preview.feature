@qtype @qtype_thddwtos @_switch_window
Feature: Preview a drag-drop into text question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | thddwtos | Drag to text          | fox      |
      | Test questions   | thddwtos | Drag to text infinite | infinite |
  ...
  Scenario: Preview a question that uses strange group numbers using the keyboard.
    Given the following "questions" exist:
      | questioncategory | qtype  | name         | template  |
      | Test questions   | thddwtos | Funny groups | oddgroups |
