 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_thddwtos_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('fox', 'maths', 'oddgroups', 'missingchoiceno', 'infinite');
    }

    /**
     * @return qtype_thddwtos_question
     */
    public function make_thddwtos_question_fox() {
        question_bank::load_question_definition_classes('thddwtos');
        $dd = new qtype_thddwtos_question();
        ...
        $dd->qtype = question_bank::get_qtype('thddwtos');
        ...
        $dd->choices = array(
            1 => array(
                1 => new qtype_thddwtos_choice('quick', 1),
                2 => new qtype_thddwtos_choice('slow', 1)),
            2 => array(
                1 => new qtype_thddwtos_choice('fox', 2),
                2 => new qtype_thddwtos_choice('dog', 2)),
            3 => array(
                1 => new qtype_thddwtos_choice('lazy', 3),
                2 => new qtype_thddwtos_choice('assiduous', 3)),
        );
     ...
     *
     * @return stdClass data to create a thddwtos question.
     */
    public function get_thddwtos_question_form_data_fox() {
     ...
     * @return stdClass data to create a thddwtos question.
     */
    public function get_thddwtos_question_form_data_oddgroups() {
        $fromform = new stdClass();
     ...
     * @return stdClass data to create a thddwtos question.
     */
    public function get_thddwtos_question_form_data_missingchoiceno() {
        $fromform = new stdClass();
     ...
     * @return qtype_thddwtos_question
     */
    public function make_thddwtos_question_maths() {
        question_bank::load_question_definition_classes('thddwtos');
        $dd = new qtype_thddwtos_question();
        ...
        $dd->choices = array(
            1 => array(
                1 => new qtype_thddwtos_choice('+', 1, true),
                2 => new qtype_thddwtos_choice('-', 1, true),
                3 => new qtype_thddwtos_choice('*', 1, true),
                4 => new qtype_thddwtos_choice('/', 1, true),
            ));
     ...
     * @return stdClass data to create a thddwtos question.
     */
    public function get_thddwtos_question_form_data_infinite() {
        $fromform = new stdClass();
