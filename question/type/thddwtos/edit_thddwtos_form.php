 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_thddwtos_edit_form extends qtype_gapselect_edit_form_base {
    ...
    protected function choice_group($mform) {
        ...
        $grouparray[] = $mform->createElement('checkbox', 'infinite', get_string('infinite', 'qtype_thddwtos'), '', null,
