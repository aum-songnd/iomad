 ...
 */
 ...
 class theme_th_lambda_st_core_course_renderer extends theme_lambda_core_course_renderer {
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
 	...
 	public function search_courses($searchcriteria) {
        ...
        if (!empty($searchcriteria)) {
            ...
            $courses = th_lambda_st_course_category::search_courses($searchcriteria, $chelper->get_courses_display_options());
            $totalcount = th_lambda_st_course_category::search_courses_count($searchcriteria);
 ...
 */
class th_lambda_st_course_category implements renderable, cacheable_object, IteratorAggregate {
    ...
    public static function search_courses($search, $options = array(), $requiredcapabilities = array()) {
        ...
        if (empty($search['blocklist']) && empty($search['modulelist']) && empty($search['tagid'])) {
            ...
            $courselist = theme_th_lambda_st_get_courses_search($searchterms, 'c.sortorder ASC', 0, 9999999, $totalcount,
