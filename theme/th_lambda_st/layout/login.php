...
$headerlogo = $OUTPUT->get_logo_url();
$headerlogourl = $headerlogo ? $headerlogo->out(false) : '';
$haslogo = !empty($headerlogourl);
    ...
    <!-- HEADER: LOGO AREA -->
            ...
            <?php } else { ?>
                <div class="logo-header">
                    ...
                    <?php 
					echo html_writer::empty_tag('img', array('src'=>$headerlogourl, 'class'=>'logo', 'alt'=>'logo'));
					?>
                    </a>
                </div>
            <?php } ?> 
