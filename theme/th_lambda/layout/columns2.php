...
<head>
    ...
    <script src="<?php echo $CFG->wwwroot ?>/theme/th_lambda/javascript/html2canvas.min.js"></script>
</head>
...
<div id="page" class="container-fluid">
    ...
    <?php
        if (core_plugin_manager::instance()->get_plugin_info('local_th_feedback_report')) {
            include($CFG->dirroot . '/theme/th_lambda/layout/feedback_report_form.php');
        } else {
            echo '<style>
                    .back-to-top {
...
<?php 
    ...
    echo html_writer::tag($tag, file_get_contents ($upOne . '/javascript/scripts.js'));
?>
