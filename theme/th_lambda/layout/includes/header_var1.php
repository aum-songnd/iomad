		...
		if (!isloggedin() or isguestuser()) {
			...
			if ($auth_googleoauth2) {
				...
				<div class="forgotpass">
									...
									<a class="btn btn-secondary" target="_self" href="<?php echo $wwwroot . '/login/index.php' ?>"><i class="<?php echo $fa_user_icon; ?>" aria-hidden="true"></i> <?php echo get_string('login') ?></a>
