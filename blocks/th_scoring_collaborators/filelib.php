 ...
 */
function file_thpluginfile_record($relativepath, $forcedownload, $preview = null, $offline = false, $embed = false) {
    global $DB, $CFG, $USER;
    ...
    // ========================================================================================================================
        ...
        require_once($CFG->dirroot . '/blocks/th_scoring_collaborators/questionlib.php');
        question_thpluginfile_record($course, $context, 'question', $filearea, $args, $forcedownload, $sendfileoptions);
        send_file_not_found();
