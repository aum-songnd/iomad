 ...
 * @since     Moodle 2.0
 */
class moodle_quiz_exception1 extends moodle_exception {
    /**
     * Constructor.
     *
 ...
 * @since      Moodle 2.0
 */
class quiz_attempt1 extends quiz_attempt{
     ...
     * @return quiz_attempt1 the desired instance of this class.
     */
    protected static function create_helper($conditions) {
        ...
        return new quiz_attempt1($attempt, $quiz, $cm, $course);
    }
    ...
    public function get_display_options($reviewing) {
        ...
        if ($reviewing) {
            if (is_null($this->reviewoptions)) {
                $this->reviewoptions = quiz_get_review_options1($this->get_quiz(),
 ...
 * @since      Moodle 2.9
 */
class quiz_nav_section_heading1 implements renderable {
 ...
 * @since      Moodle 2.1
 */
class quiz_nav_question_button1 implements renderable {
 ...
 * @since      Moodle 2.0
 */
abstract class quiz_nav_panel_base1 {
    /** @var quiz_attempt */
 ...
 * @since      Moodle 2.0
 */
class quiz_attempt_nav_panel1 extends quiz_nav_panel_base {
 ...
 * @since      Moodle 2.0
 */
class quiz_review_nav_panel1 extends quiz_nav_panel_base {
    public function get_question_url($slot) {
